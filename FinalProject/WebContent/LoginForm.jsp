...
<body>
	...
	<div>
		...
		<div class="d-flex justify-content-center h-100 container">
			<div class="card">
				...
				<div class="card-body">
					<form method="post" id="loginForm">
						<div class="input-group form-group">
							...
							<input id="id" name="id" type="text" style="width: 30px;"
				...
				<div class="form-group">
					<input type="submit" value="회원가입" style="margin-right: 40px;"
						class="btn float-right subbtn"> <input type="submit"
						value="ID찾기" style="margin-right: 40px;"
						class="btn float-right subbtn"> <input type="submit"
						value="PW찾기" style="margin-right: 40px;"
						class="btn float-right subbtn">
				</div>
